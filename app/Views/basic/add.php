		...
		<div class="row">
			<div class="col-xl-8 col-lg-8 col-md-8 col-sm-8">
				...
				<div class="page-title">
					<h5>Basic</h5>
					<h6 class="sub-heading">Basic / Add</h6>
				</div>
			</div>
...
<div class="main-content">
	<div class="row gutters">
		<div class="col-md-12">
			<form method="post" action="<?= base_url('basic/create'); ?>" enctype="multipart/form-data">
				<div class="card">
					<div class="card-header main-head">Add Basic</div>
            <div class="card-body">
            <?php 
