...
<script src="<?= base_url() ?>/assets/vendor/chartist/js/custom/custom-line-chart.js"></script>
<script src="<?= base_url() ?>/assets/vendor/chartist/js/custom/custom-line-chart1.js"></script>
...
<!-- Notify -->
<script src="<?= base_url('assets/vendor/notify/bootstrap-notify.js'); ?>"></script>
